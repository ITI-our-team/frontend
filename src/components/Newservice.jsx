...
function Newservice({ api_url }) {
    ...
    async function cancel() {
        navigate('/dashboard');
        toast.success("Canceled service creation");
    }
    ...
    async function myHandleSubmit(data) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.error(result.detail || "Failed to create service. Please check your inputs.");
            }
        } catch (error) {
        ...
        <section className="login-page">
            <div className="login-box">
                ...
                <form onSubmit={handleSubmit(myHandleSubmit)} className='col-12 signupform'>
                    ...
                    <textarea {...register("description", { required: true })} id="serv_desc" placeholder="Description" className='w-100 p-3' rows="4" />
                    
                    <label htmlFor="serv_loc">Location *</label>
                    <input {...register("location", { required: true })} id="serv_loc" placeholder="Click on map to set location" readOnly />
                    
                    <div className='leaflocation_minimap' style={{ height: "300px", marginBottom: "20px", borderRadius: "8px", overflow: "hidden" }}>
                    ...
                    <div className="col-3 mx-auto mt-2 ">
                        <button className='bg-danger' onClick={cancel}>Cancel</button>
                    </div>
                </form>
            </div>
        </section>
